  ...
  return (
    <>
      ...
      <nav className="mt-12 flex flex-col p-4 gap-4">
        ...
        <Link onClick={handleClick} to="/attendance"
        className={`flex items-center gap-1 font-semibold text-xl text-black/80 rounded-xl py-2 pl-4
        cursor-pointer hover:bg-Hnav/25 ${location.pathname === "/attendance" ? "bg-Hnav/25" : "bg-nav"}`}
        >
          <FaListCheck /> Attendance
        </Link>
